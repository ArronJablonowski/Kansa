...
#######################################
function searchOldOfficeFiles() {
    Get-ChildItem -Recurse -file -path $searchPath -Include *.doc, *.xls -ErrorAction $erroractionpref | 
