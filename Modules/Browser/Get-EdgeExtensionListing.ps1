...
$listOfExtensions = @()
# Get the Edge Extension folder listing for each user 
$users = Get-ChildItem C:\Users

foreach ($user in $users){
    $Extensions = $($user.FullName)+"\AppData\Local\Microsoft\Edge\User Data\Default\Extensions"
    $SyncExtensions = $($user.FullName)+"\AppData\Local\Microsoft\Edge\User Data\Default\Sync Extension Settings"
